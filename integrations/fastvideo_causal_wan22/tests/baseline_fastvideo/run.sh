...
echo "[run] starting FastVideo causal Wan2.2 T2V benchmark"
FASTVIDEO_ATTENTION_BACKEND=TORCH_SDPA \
FASTVIDEO_FORCE_CUDNN_SDPA=1 \
PYTHONPATH="${REPO_DIR}:${PYTHONPATH:-}" \
"${SCRIPT_DIR}/.venv/bin/python" "${REPO_DIR}/examples/inference/basic/benchmark_self_forcing_causal_wan2_2_t2v.py" \
