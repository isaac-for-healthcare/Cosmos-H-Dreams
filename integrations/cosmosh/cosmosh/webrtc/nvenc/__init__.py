...
The CPU path (the existing ``cosmosh.webrtc.media`` module) is preserved
...
:mod:`cosmosh.webrtc.nvenc.resolver` for the precedence and the auto
probe.
...
from cosmosh.webrtc.nvenc.video_encoder import (
    ChunkDeliveryResult,
