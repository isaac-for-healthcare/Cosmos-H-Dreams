...
should rely on :func:`cosmosHDreams.webrtc.nvenc.resolver.resolve_encoder` to avoid
ever instantiating this class.

The wrapper accepts ARGB GPU tensors as produced by
:func:`cosmosHDreams.webrtc.nvenc.pack.denormalize_and_pack_argb` and yields one
