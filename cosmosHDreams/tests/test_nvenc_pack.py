...
"""Unit tests for ``cosmosHDreams.webrtc.nvenc.pack``.
...
- Per-pixel RGB values are at most 1 LSB away from the reference
  ...
  ``cosmosHDreams.webrtc.media.tensor_chunk_to_rgb_frames``. The slight
...
from cosmosHDreams.webrtc.nvenc.pack import (
